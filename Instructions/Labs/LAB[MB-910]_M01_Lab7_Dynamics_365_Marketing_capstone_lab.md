---
lab:
  title: 'النشاط المعملي 1.7: النشاط المعملي لمشروع التخرّج Dynamics 365 Marketing'
...
ms.locfileid: "137908716"
---
<a name="module-1-learn-the-fundamentals-of-dynamics-365-marketing"></a>الوحدة 1: تعلم أساسيات Dynamics 365 Marketing
========================

## <a name="practice-lab-17---dynamics-365-marketing-capstone-lab"></a>معمل التدريب 1.7 - معمل مشروع التخرّج Dynamics 365 Marketing
...
## <a name="exercise-1-create-a-marketing-email"></a>التمرين 1: إنشاء رسالة بريد إلكتروني تسويقية
...
7. في الحقل **Subject** أدخل النص **Keep you family Safe**! قد تحتاج إلى التمرير إلى أعلى صفحة التصميم للكشف عن حقل الموضوع.
...
## <a name="exercise-2-create-a-segment-in-dynamics-365-marketing"></a>التمرين 2: إنشاء قسم في Dynamics 365 Marketing

### <a name="task-1-add-some-sample-contacts-to-work-with"></a>المهمة 1: إضافة مجموعة من نماذج جهات الاتصال للعمل معها 
...
3. أكمل صفحة **جهة اتصال جديدة** على النحو التالي.
    ...
    - **Last Name**: سميث - الأحرف الأولى من اسمك

    - **Email**: أدخِل عنوان بريد إلكتروني يمكنك تلقي البريد منه.

    - **Address 1 Street 1:** 1989 191<sup data-htmlnode="">شارع</sup> Ave N

    - **Address 1: City**: سياتل

    - **Address 1 State:** واشنطن

    - **Address 1 Zip/Postal:** 98001

4. بمجرد الانتهاء من معلومات جهة الاتصال، حدد **Save &amp; Close**.
...
7. أكمل جهة الاتصال الثانية على النحو التالي:
    ...
    - **Last Name**: عنوان بريدك الإلكتروني
...
### <a name="task-2-create-a-customer-segment"></a>المهمة 2: إنشاء قطاع عملاء
...
10. أدخل كلمة المدينة لتصفية القائمة. حدد **Address 1: City** من القائمة.
...
### <a name="task-3-test-your-customer-segment"></a>المهمة 3: اختبار قطاع العميل الخاص بك
...
3. أكمل صفحة **جهة اتصال جديدة** على النحو التالي.
    ...
    - **Last Name**: جونز - الأحرف الأولى من اسمك
...
**IMPORTANT:** نظرًا لأننا نعمل في بيئة مشتركة ويعمل الجميع في النظام نفسه، فمن المحتمل أن ترى جهات اتصال أخرى في قطاع التسويق الديناميكي أيضًا. هذا جيد لأغراض هذه الدورة التدريبية. 

## <a name="exercise-3-create-a-customer-journey"></a>التمرين 3: إنشاء رحلة العميل
...
7. في لوحة التصميم، حرك المؤشر بين **البداية** و **النهاية**. حدد علامة **+** ، من القائمة التي تظهر، حدد **Send an email**.
...
9. حرِّك المؤشر بعد إرسال رسالة بريد إلكتروني. حدد علامة **+** ، من القائمة التي تظهر، حدد **If/Then**.
...
13. في المسار **Yes**، حدد علامة **+** . من القائمة التي تظهر، حدد **إنشاء عميل متوقع**.
