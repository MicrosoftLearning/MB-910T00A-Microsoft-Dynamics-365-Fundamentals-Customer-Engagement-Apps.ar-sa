---
lab:
  title: 'النشاط المعملي 3.3: النشاط المعملي لمشروع التخرّج Dynamics 365 Customer Service'
...
## <a name="practice-lab-33---dynamics-365-customer-service-capstone-lab"></a>معمل التدريب 3.3 - معمل مشروع التخرّج Dynamics 365 Customer Service"
...
## <a name="exercise-1-create-and-publish-a-knowledge-article"></a>التمرين 1: إنشاء مقالة معرفية ونشرها

### <a name="task-1-create-a-knowledge-article"></a>المهمة 1: إنشاء مقالة معرفية
...
8. أكمل المقالة على النحو التالي:
    ...
    - **Description:** يساعد في العمل من خلال السيناريوهات التي لا يعمل فيها المستشعر. 
...
### <a name="task-2-manage-an-article-through-the-approval-process"></a>المهمة 2: إدارة مقالة من خلال عملية الموافقة
...
6. حدد **Save &amp; Close** لإغلاق سجل المقالة.
...
15. في **شريط الأوامر**، حدد زر **Save &amp; Close**.
...
### <a name="task-3-approve-the-knowledge-article"></a>المهمة 3: الموافقة على المقالة المعرفية
...
## <a name="exercise-2-manage-a-support-case-through-its-lifecycle"></a>التمرين 2: إدارة حالة الدعم خلال دورة حياتها


### <a name="task-1-create-and-manage-a-case"></a>المهمة 1: إنشاء حالة وإدارتها
...
12. أكمل سجل الحالة الجديد على النحو التالي:
    ...
    - **Case Title:** المستشعر لا يعمل - الأحرف الأولى من اسمك

    - **Customer:** بايبر سميث

    - **Origin:** هاتف

    - **Description:** أبلغت بايبر أن أحد المستشعرات التي تلقتها لا يعمل بشكلٍ صحيح. 
...
16. في **Quick Create: يُكمِل نموذج Phone Call** النشاط على النحو التالي:

    - **Subject:** إعادة الاتصال ببايبر

    - **الاتجاه:** صادر

    - **Phone number:**  1762-555 888
...
23. في **Quick Create: يُكمِل نموذج Phone Call** النشاط على النحو التالي:

    - **Subject:** البحث عن مشكلة بايبر

    - **Description:** الاستفادة من قاعدة المعرفة للبحث عن مشكلة بايبر. 
...
### <a name="task-2-close-the-case"></a>المهمة 2: إغلاق الحالة
...
1. في **Timeline** لسجل الحالات، قم بالمرور فوق **Research Pipers Issue task** التي أنشأتها مسبقًا **.** حدد علامة الإكمال **أيقونة علامة الاختيار** لإكمال النشاط. 

2. في شاشة **إغلاق المهمة**، تحقق من اكتمال الحالة وحدد زر **إغلاق**. ينبغي أن تشير حالة المهمة إلى **مغلقة**. 

3. قم بالمرور فوق **Return call to piper Phone Call** التي أنشأتها مسبقًا **.** حدد علامة الإكمال **أيقونة علامة الاختيار** لإكمال النشاط. 

4. في شاشة **إغلاق المكالمة الهاتفية**، تحقق من أن **الحالة** **مكتملة** وأن **الحالة** قد **اكتملت**. حدد الزر "**Close**". تحقق من ظهور النشاط على أنه مغلق في المخطط الزمني. 
